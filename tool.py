...
def approval():
    ...
    try:
        ...
        clear()
        print(" You Need Approval To Use This Tool, your key is not approved yet")
        print(" Paid tool. ")
        print(f"Send this key to the admin ->:\u001b[36m {key}")
        linex()
        ...
        if key_found:
            print(f"THE ADMIN APPROVED YOUR KEY")
            return key
        else:
...
def approvalf():
    ...
    try:
       ...
       # clear()
        ###print("Your key is not approved yet")
        ###print("kindly contact the administrator if you want to purchase")
        ###print(f"send Your Key to the admin: {key}")
        #linex()
